...
void bfs(std::vector<std::string> grid, int r, int c, int px, int py, int fx, int fy) {
    std::queue<Point> s; // ONLY DIFFERENCE BETWEEN QUEUE AND STACK
